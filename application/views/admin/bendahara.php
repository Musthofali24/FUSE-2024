												...
												<tr>
													...
													<td>
														<a class="btn btn-primary"
															href="<?= '/assets/uploads/' . $p->pembayaran ?>">
															<?= $p->pembayaran ?>
														</a>
													</td>
													<td>
														<?= $p->rekomendasi_bendahara ?>
													</td>
													<?php if ($p->rekomendasi_div_lomba == 'Di Konfirmasi' and $p->rekomendasi_bendahara == 'Belum Di Konfirmasi' or $p->rekomendasi_bendahara == 'Tidak Di Konfirmasi') { ?>
														<td>
															<?php echo anchor('register/update_success_bendahara/' . $p->id_pendaftaran, '<button type="button" class="btn btn-primary mb-1">Konfirmasi</button>'); ?>
															<?php echo anchor('register/update_error_bendahara/' . $p->id_pendaftaran, '<button type="button" class="btn btn-danger">Reject</button>'); ?>
														</td>
													<?php } else if ($p->rekomendasi_bendahara == 'Di Konfirmasi') { ?>
															<td>
																<button type="button" class="btn btn-success">DONE</button>
															</td>
													<?php } else { ?>
															<td>
															<?php echo anchor('register/delete/' . $p->id_pendaftaran, '<button type="button" class="btn btn-danger">Delete</button>'); ?>
															</td>
													<?php } ?>
												</tr>
											<?php } ?>

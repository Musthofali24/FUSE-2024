<body>
	...
	<div class="form_regist">
		<div class="container">
			...
			<form action="<?= base_url('register/update_regist_plc'); ?>" class="form" method="post"
				...
				<div class="input-box">
					...
					<div class="select-box">
						<input type="text" name="competition-category" id="competition-category" value="PLC UNIV" readonly>
					</div>
				</div>
				<div class="input-box">
				...
				<div class="input-box">
					...
					<input type="text" name="email" id="email" placeholder="Enter team name" value="<?=$registrasi['email']?>" required />
				</div>
				<div class="column">
					<div class="input-box">
					...
					<div class="input-box">
						...
						<input type="text" name="member2-name" id="member2-name" placeholder="Enter member 2 name"
							value="<?= $registrasi['nama_peserta_2'] ?>" required />
					</div>
				</div>
				<div class="input-box">
				...
				<div class="input-box">
					<div class="input-box">
						...
						<?php endif; ?>
						<input type="file" name="payment_proof" size="2048" accept=".jpg,.jpeg,.png" required />
					</div>
				</div>
				<div class="input-box">

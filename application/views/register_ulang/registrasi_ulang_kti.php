<body>
	...
	<div class="form_regist">
		<div class="container">
			...
			<form action="<?= base_url('register/update_regist_kti'); ?>" class="form" method="post"
				...
				<div class="column">
					...
					<div class="input-box">
						...
						<input type="text" name="member3-name" id="member2-name" placeholder="Enter member 2 name"
							value="<?= $registrasi['nama_peserta_3'] ?>" required />
					</div>
				</div>
				<div class="input-box">

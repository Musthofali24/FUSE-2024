<body>
	...
	<div class="form_regist">
		<div class="container">
			...
			<form action="<?= base_url('register/regist_plc'); ?>" class="form" method="post"
				enctype="multipart/form-data">
				<div class="input-box">
					<label for="competition-category">Competition Category <span>*</span></label>
					<div class="select-box">
						<input type="text" name="competition-category" id="competition-category" value="PLC UNIV"
							readonly>
					</div>
				</div>
				<div class="input-box">
					<label for="school-name">University Name <span>*</span></label>

<body>
	...
	<div class="form_regist">
		<div class="container">
			...
			<form action="<?= base_url('register/regist_lf'); ?>" class="form" method="post"
				enctype="multipart/form-data">
				<div class="input-box">
					<label for="competition-category">Competition Category <span>*</span></label>
					<div class="select-box">
						<input type="text" name="competition-category" id="competition-category" value="LINE FOLLOWER"
							readonly>
					</div>
				</div>
				...
				<div class="input-box">
					<label for="twibbon">Bukti upload twibbon ke IG
						<span>( Berupa PNG/JPG ) *</span></label>
					<input type="file" name="twibbon" size="2048" accept=".jpg,.jpeg,.png" required />
				</div>
				<div class="column">
					<div class="input-box">
						<label for="photo">Foto 3x4 <span>( Berupa PNG/JPG ) *</span></label>
						<input type="file" name="photo" size="2048" accept=".jpg,.jpeg,.png" required />
					</div>
					<div class="input-box">
						<label for="tiktok-follow">Bukti follow tiktok fuse <span>( Berupa PNG/JPG ) *</span></label>
						<input type="file" name="tiktok-follow" size="2048" required />
					</div>
				</div>
				<div class="input-box">
					<div class="input-box">
